...
train_df["experiment_name"] = train_df["experiment_name"].str.replace("Gcn", "GCN")
train_df["Experiment Name"] = train_df["experiment_name"].str.replace("Gat", "GAT")
...
sns.lineplot(data=train_df, x="epoch", y="loss", hue="Experiment Name")
...
plt.savefig("loss_validation_architecture.png", dpi=300)
...
# Rename the y-axis label
plt.ylabel("Loss")
# Rename the x-axis label of all subplots
plt.xlabel("Epoch")
# Fit plot
plt.tight_layout()
plt.savefig("loss_validation_architecture_per_task.png", dpi=300)
